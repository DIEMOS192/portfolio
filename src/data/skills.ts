...
export const skills: Skill[] = [
  ...
  { name: "TypeScript", iconClass: "fas fa-file-code" }, // File-code icon for TypeScript
  ...
  { name: "SSIS", iconClass: "fas fa-server" }, // Server icon for SSIS
  { name: "Git", iconClass: "fab fa-git-alt" },
  { name: "VS Code", iconClass: "fas fa-edit" }, // Edit icon for VS Code
];
